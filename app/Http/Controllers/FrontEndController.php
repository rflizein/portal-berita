...
class FrontEndController extends Controller
{
    ...
    public function detailCategory($slug)
    {
        ...
        return view('frontend.detail-category', compact('title', 'news', 'nav_category', 'side_news'));
    }
    ...
    public function detailNews($slug)
    {
        ...
        return view('frontend.detail-news', compact('news', 'title', 'nav_category', 'side_news'));
    }
